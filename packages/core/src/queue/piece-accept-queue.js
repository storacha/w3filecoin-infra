...
/**
 * @typedef {import('@storacha/filecoin-api/aggregator/api').PieceAcceptMessage} PieceAcceptMessage
 ...
 * @returns {import('@storacha/filecoin-api/aggregator/api').PieceAcceptQueue}
 */
