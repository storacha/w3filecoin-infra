 ...
 * @typedef {import('@storacha/filecoin-api/aggregator/api').PieceRecordKey} PieceRecordKey
 * @typedef {import('./types.js').InferStoreRecord<PieceRecord>} InferStoreRecord
 * @typedef {import('./types.js').AggregatorPieceStoreRecord} PieceStoreRecord
 * @typedef {import('./types.js').AggregatorPieceStoreRecordStatus} PieceStoreRecordStatus
 ...
 * @returns {import('@storacha/filecoin-api/aggregator/api').PieceStore}
 */
